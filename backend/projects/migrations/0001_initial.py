    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('about', models.TextField(blank=True, max_length=750, validators=[projects.validators.validate_about], verbose_name='Об организации')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, unique=True, validators=[projects.validators.validate_name], verbose_name='Название')),
                ...
                ('photo_previous_event', models.ImageField(blank=True, upload_to='', verbose_name='Фото с мероприятия')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, upload_to='', verbose_name='Фото')),
                ('date_of_birth', models.DateField(help_text='Введите дату в формате "ГГГГ-ММ-ДД", пример: "2000-01-01".', validators=[django.core.validators.MinValueValidator(limit_value=datetime.date(1900, 1, 1)), django.core.validators.MaxValueValidator(limit_value=datetime.date(2023, 11, 15))], verbose_name='Дата рождения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_letter', models.TextField(blank=True, null=True, validators=[projects.validators.regex_string_validator, projects.validators.LengthValidator(max_length=750, min_length=10)], verbose_name='Сопроводительное письмо')),
