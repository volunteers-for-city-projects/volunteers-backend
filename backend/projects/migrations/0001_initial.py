    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('about', models.TextField(verbose_name='Об организации')),
                ('city', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='organization', to='content.city', verbose_name='Город')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_datatime', models.DateTimeField(verbose_name='Дата начало мероприятия')),
                ('end_datatime', models.DateTimeField(verbose_name='Дата окончания мероприятия')),
                ...
                ('status_project', models.CharField(blank=True, choices=[('open', 'Открыт'), ('ready_for_feedback', 'Готов к откликам'), ('reception_of_responses_closed', 'Прием откликов окончен'), ('project_completed', 'Проект завершен')], default=None, max_length=100, null=True, verbose_name='Статус проекта')),
                ('photo_previous_event', models.ImageField(blank=True, null=True, upload_to='', verbose_name='Фото с мероприятия')),
                ('status_approve', models.CharField(choices=[('approved', 'Одобрено'), ('pending', 'На рассмотрении'), ('rejected', 'Отклонено')], default='pending', max_length=50, verbose_name='Статус проверки')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_birth', models.DateField(help_text='Введите дату в формате "ДД.ММ.ГГГГ", пример: "01 01 2000".', validators=[django.core.validators.MinValueValidator(limit_value=datetime.date(1900, 1, 1)), django.core.validators.MaxValueValidator(limit_value=datetime.date(2023, 10, 17))], verbose_name='Дата рождения')),
