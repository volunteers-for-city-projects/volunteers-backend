# Generated by Django 4.2.6 on 2023-11-03 16:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, validators=[projects.validators.validate_name], verbose_name='Название')),
                ('description', models.TextField(validators=[projects.validators.regex_string_validator, projects.validators.LengthValidator(max_length=750, min_length=10)], verbose_name='Описание')),
                ...
                ('start_date_application', models.DateTimeField(verbose_name='Дата и время, начало подачи заявок')),
                ('end_date_application', models.DateTimeField(verbose_name='Дата и время, окончания подачи заявок')),
                ('event_purpose', models.TextField(validators=[projects.validators.regex_string_validator, projects.validators.LengthValidator(max_length=750, min_length=10)], verbose_name='Цель проекта')),
                ('project_tasks', models.TextField(validators=[projects.validators.regex_string_validator, projects.validators.LengthValidator(max_length=750, min_length=2)], verbose_name='Задачи проекта')),
                ('project_events', models.TextField(validators=[projects.validators.regex_string_validator, projects.validators.LengthValidator(max_length=750, min_length=2)], verbose_name='Мероприятия на проекте')),
                ...
                ('event_address', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='projects.address', verbose_name='Адрес проведения проекта')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, upload_to='', verbose_name='Фото')),
                ('date_of_birth', models.DateField(help_text='Введите дату в формате "ГГГГ.ММ.ДД", пример: "2000 01 01".', validators=[django.core.validators.MinValueValidator(limit_value=datetime.date(1900, 1, 1)), django.core.validators.MaxValueValidator(limit_value=datetime.date(2023, 11, 3))], verbose_name='Дата рождения')),
